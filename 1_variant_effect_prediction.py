...
if __name__ == "__main__":
    ...
    genome = None
    if hg_version == 'hg38' or hg_version == 'hg19' or hg_version == 'dlabrax' or 'allspecies' or 'maximus' or 'carpio_maximus':
        genome = Genome(
            os.path.join('.', 'resources', '{0}_UCSC.fa'.format(hg_version)))
    else:
        raise ValueError("--genome=<hg> must be 'hg19', 'hg38' or 'dlabrax', or 'allspecies', or 'maximus', or 'carpio_maximus'")
    ...
    run_config("./model/sei_varianteffect_prediction_dlabrax2021.yml", sei_out)
